...
const Sidebar = ({ 
  ...
  const menuItems = [
    { path: "/dosen", name: "Dashboard", icon: <FiGrid size={17} /> },
    { path: "/dosen/absensi", name: "Kelola Absensi", icon: <FiCheckSquare size={17} /> },
    { path: "/dosen/nilai", name: "Kelola Nilai", icon: <FiBookOpen size={17} /> },
    { path: "/dosen/jadwal", name: "Jadwal", icon: <FiCalendar size={17} /> }
  ];
