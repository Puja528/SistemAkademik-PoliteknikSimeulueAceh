    ...
    <div className="flex flex-col gap-6 p-6 bg-[#f4f6f9] min-h-screen font-sans text-xs text-slate-700 w-full">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
          ...
          <div>
            <button onClick={muatDaftarHadirMahasiswa} className="w-full flex items-center justify-center gap-2 bg-[#1a3a6b] text-white rounded-lg px-4 py-1.5 hover:bg-[#244b86] transition font-bold text-xs shadow-sm cursor-pointer h-[32px]">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm flex-1">
        ...
        {daftarMahasiswa.length === 0 && (
          <div className="text-center py-10 text-gray-400 flex flex-col items-center gap-2">
            ...
            <p className="font-medium">Pilih mata kuliah terlebih dahulu, lalu klik tombol Tampilkan.</p>
          </div>
        )}
      </div>
    </div>
