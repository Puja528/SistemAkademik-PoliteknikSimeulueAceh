      ...
      <form onSubmit={tanganiSimpanMahasiswa} className="max-w-4xl mx-auto w-full text-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs bg-gray-50/50 font-mono text-gray-700 focus:outline-none focus:border-slate-400 transition disabled:bg-gray-100" 
                />
              </div>
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs bg-white text-gray-700 font-medium focus:outline-none focus:border-slate-400 transition disabled:bg-gray-100" 
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex flex-col gap-1.5 lg:col-span-2">
                ...
                <select 
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs bg-white text-gray-700 font-medium cursor-pointer focus:outline-none focus:border-slate-400 transition disabled:bg-gray-100"
                >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select 
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs bg-white text-gray-700 font-semibold cursor-pointer focus:outline-none focus:border-slate-400 transition disabled:bg-gray-100"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex flex-col gap-1.5 md:col-span-2">
                ...
                <div className={`flex items-center bg-white border rounded-lg overflow-hidden transition focus-within:border-slate-400 ${emailError ? 'border-red-400' : 'border-gray-200'} ${isSubmitting ? 'bg-gray-100' : ''}`}>
                  <input 
                    type="text" 
                    required 
                    disabled={isSubmitting}
                    ...
                    className="w-full bg-transparent text-xs px-3 py-2 text-gray-700 font-medium focus:outline-none disabled:cursor-not-allowed" 
                  />
        ...
        <div className="border-t border-gray-200 pt-8 mt-12 flex justify-end gap-2.5">
          <button 
            ...
            disabled={isSubmitting}
            onClick={tutupModal} 
            className="bg-gray-50 hover:bg-gray-100 text-gray-600 text-xs font-semibold px-5 py-2 rounded-lg transition border border-gray-200 cursor-pointer disabled:opacity-50"
          >
            Batalkan
          </button>
